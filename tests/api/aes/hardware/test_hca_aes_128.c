...
TEST(hca_aes_128, ccm_1)
{
     ...
     */
    static const uint64_t key128[4] = {0, 0, 0x0280cb87abad0bb3, 0xd24a3d3dde8c8483};
    ...
    static const uint64_t tag[2] __attribute__((aligned(8))) = {
        0xb7c373ad4b3ad67b,
        0x1123301219c70599
    };
    ...
    result = hca_aes_auth_core(&scl, &ctx_aes_auth, SCL_BIG_ENDIAN_MODE, payload_be, sizeof(payload_be), tmp);
    TEST_ASSERT_TRUE(SCL_OK == result);
    TEST_ASSERT_TRUE(0 == memcmp(ciphertext_be, tmp, sizeof(ciphertext_be)));
...
TEST(hca_aes_128, ccm_2)
{
     ...
     */
    static const uint64_t key128[4] = {0, 0, 0x4a3dedb19d20f6c8, 0x2ebf60f0969013a5};
...
TEST(hca_aes_128, ccm_3)
{
     ...
     */
    static const uint64_t key128[4] = {0, 0, 0xc26924925af6b670, 0x10a7720f2e18f739};

    static const uint64_t IV[2] = {0xafee01c628000000, 0x8c4e7813ab9bce9d};

    static const uint8_t aad_be[16] __attribute__((aligned(8))) = {
        0xa2, 0x09, 0x94, 0x1f, 0xab, 0x71, 0x0f, 0xda, 0x38, 0xd1, 0x1c, 0x68, 0xb1, 0x3d, 0x93, 0x0f
    };

    static const uint8_t payload_be[24] __attribute__((aligned(8))) = {
        0xe5, 0x97, 0x82, 0xa9, 0xae, 0xa4, 0x5f, 0x46, 0x7b, 0x90, 0xe5, 0x1a, 0x0f, 0xdf, 0x16, 0x6b,
        0xab, 0xa0, 0x56, 0x63, 0xde, 0xf2, 0xd8, 0xb6
    };

    static const uint8_t ciphertext_be[24] __attribute__((aligned(8))) = {
        0xe3, 0x57, 0xb1, 0xcc, 0xda, 0xca, 0x6f, 0x35, 0x06, 0xdc, 0x45, 0x27, 0x9c, 0x2e, 0x4c, 0x59,
        0xf5, 0x30, 0x7a, 0x5f, 0xd6, 0xa9, 0x9c, 0xd7
    };
...
TEST(hca_aes_128, ccm_4)
{
     ...
     */
    static const uint64_t key128[4] = {0, 0, 0x85d6e2b77ec3d4f2, 0x35b403a152120970};

    static const uint64_t IV[2] = {0xc347a293aa000000, 0xdaa423bf9256c3fc};

    static const uint8_t aad_be[24] __attribute__((aligned(8))) = {
        0xd3, 0xc0, 0xed, 0x74, 0xe5, 0xf2, 0x5e, 0x4c, 0x1e, 0x47, 0x9e, 0x1a, 0x51, 0x18, 0x2b, 0xb0,
        0x18, 0x69, 0x8e, 0xc2, 0x67, 0x26, 0x91, 0x49
    };

    static const uint8_t payload_be[24] __attribute__((aligned(8))) = {
        0x7d, 0xd7, 0x39, 0x6d, 0xb6, 0x61, 0x3e, 0xb8, 0x09, 0x09, 0xa3, 0xb8, 0xc0, 0x02, 0x9b, 0x62,
        0x49, 0x12, 0xaa, 0xbe, 0xdd, 0xa0, 0x65, 0x9b
    };

    static const uint8_t ciphertext_be[24] __attribute__((aligned(8))) = {
        0x5b, 0x00, 0xcf, 0x8a, 0x66, 0xba, 0xa7, 0xfe, 0x22, 0x50, 0x2e, 0xd6, 0xf4, 0x86, 0x1a, 0xf7,
        0x1f, 0xa6, 0x4b, 0x55, 0x0d, 0x64, 0x3f, 0x95
    };
...
TEST(hca_aes_128, ccm_4b)
{
    ...
    static const uint64_t aad_le[3] = {
        0x1e479e1a51182bb0,
        0xd3c0ed74e5f25e4c,
        0x18698ec267269149
    };
    ...
    result = hca_aes_auth_core(&scl, &ctx_aes_auth, SCL_LITTLE_ENDIAN_MODE, (uint8_t *)payload_le, sizeof(payload_le), tmp);
    TEST_ASSERT_TRUE(SCL_OK == result);
    TEST_ASSERT_TRUE(0 == memcmp(ciphertext_le, tmp, sizeof(ciphertext_le)));
...
TEST(hca_aes_128, gcm_1)
{
     ...
     */
    static const uint64_t key128[4] = {0, 0, 0x030f33798b07176d, 0x594157ec4693202b};
    ...
    static const uint8_t ciphertext_be[51] __attribute__((aligned(8))) = {
        0xc1, 0xb7, 0xa4, 0x6a, 0x33, 0x5f, 0x23, 0xd6, 0x5b, 0x8d, 0xb4, 0x00, 0x8a, 0x49, 0x79, 0x69,
        0x06, 0xe2, 0x25, 0x47, 0x4f, 0x4f, 0xe7, 0xd3, 0x9e, 0x55, 0xbf, 0x2e, 0xfd, 0x97, 0xfd, 0x82,
        0xd4, 0x16, 0x7d, 0xe0, 0x82, 0xae, 0x30, 0xfa, 0x01, 0xe4, 0x65, 0xa6, 0x01, 0x23, 0x5d, 0x8d,
        0x68, 0xbc, 0x69
    };
    ...
    result = hca_aes_auth_init(&scl, &ctx_aes_auth, SCL_AES_GCM, SCL_ENCRYPT, SCL_BIG_ENDIAN_MODE, 0, NULL, 0, sizeof(payload_be));
    TEST_ASSERT_TRUE(SCL_OK == result);
...
TEST(hca_aes_128, gcm_2)
{
     ...
     */
    static const uint64_t key128[4] = {0, 0, 0x1d8285c564f75e2b, 0x99e3e8793e686e57};

    static const uint64_t IV[2] = {0xad9c0d2300000000, 0xc2dd0ab868da6aa8};

    static const uint8_t aad_be[48] __attribute__((aligned(8))) = {
        0xb6, 0x68, 0xe4, 0x2d, 0x4e, 0x44, 0x4c, 0xa8, 0xb2, 0x3c, 0xfd, 0xd9, 0x5a, 0x9f, 0xed, 0xd5,
    ...
    result = hca_aes_auth_init(&scl, &ctx_aes_auth, SCL_AES_GCM, SCL_ENCRYPT, SCL_BIG_ENDIAN_MODE, 0, aad_be, sizeof(aad_be), 0);
    TEST_ASSERT_TRUE(SCL_OK == result);
...
TEST(hca_aes_128, gcm_3)
{
     ...
     */
    static const uint64_t key128[4] = {0, 0, 0x87ecc760bd8ec184, 0x48b7f337cdf92526};
    ...
    result = hca_aes_auth_init(&scl, &ctx_aes_auth, SCL_AES_GCM, SCL_ENCRYPT, SCL_BIG_ENDIAN_MODE, 0, aad_be, sizeof(aad_be), sizeof(payload_be));
    TEST_ASSERT_TRUE(SCL_OK == result);
