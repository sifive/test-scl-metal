...
TEST(soft_test_sha_224, msg_abc_all_aligned)
{
    int32_t result = 0;
    sha_ctx_t ctx;
...
TEST(soft_test_sha_224, msg_2_blocks_all_aligned)
{
    int32_t result = 0;
    sha_ctx_t ctx;
...
TEST(soft_test_sha_224, msg_abc_msg_not_aligned)
{
    int32_t result = 0;
    sha_ctx_t ctx;
...
TEST(soft_test_sha_224, msg_2_blocks_msg_not_aligned)
{
    int32_t result = 0;
    sha_ctx_t ctx;
...
TEST(soft_test_sha_224, msg_abc_digest_not_aligned)
{
    int32_t result = 0;
    sha_ctx_t ctx;
...
TEST(soft_test_sha_224, msg_2_blocks_digest_not_aligned)
{
    int32_t result = 0;
    sha_ctx_t ctx;
