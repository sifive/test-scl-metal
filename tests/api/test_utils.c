...
TEST(utils, memcmp_u64_a_equals_b)
{
    int32_t result = 0;
    size_t word_size;
    ...
    result = memcmp_u64(a, b, word_size);

    TEST_ASSERT_TRUE(0 == result);
}

TEST(utils, memcmp_u64_a_greater_than_b_lsb)
{
    int32_t result = 0;
    size_t word_size;
...
TEST(utils, memcmp_u64_a_greater_than_b_msb)
{
    int32_t result = 0;
    size_t word_size;
...
TEST(utils, memcmp_u64_a_lower_than_b_lsb)
{
    int32_t result = 0;
    size_t word_size;
...
TEST(utils, memcmp_u64_a_lower_than_b_msb)
{
    int32_t result = 0;
    size_t word_size;
