...
TEST_SETUP(scl_soft_test_sha_512) { (void)scl_init(&scl); }
...
TEST(scl_soft_test_sha_512, msg_abc_msg_not_aligned)
{
    ...
    result = scl_sha(SCL_HASH_SHA512, &message[1], sizeof(message) - 1, digest,
                     &digest_len);
    TEST_ASSERT_TRUE(0 == result);
    TEST_ASSERT_TRUE(SHA512_BYTE_HASHSIZE == digest_len);
    TEST_ASSERT_TRUE(0 ==
...
TEST(scl_soft_test_sha_512, msg_2_blocks_msg_not_aligned)
{
    ...
    result = scl_sha(SCL_HASH_SHA512, &message[1], sizeof(message) - 2, digest,
                     &digest_len);
    TEST_ASSERT_TRUE(0 == result);
    TEST_ASSERT_TRUE(SHA512_BYTE_HASHSIZE == digest_len);
    TEST_ASSERT_TRUE(0 ==
...
TEST(scl_soft_test_sha_512, msg_abc_digest_not_aligned)
{
    ...
    result = scl_sha(SCL_HASH_SHA512, message, sizeof(message), &digest[1],
                     &digest_len);
    TEST_ASSERT_TRUE(0 == result);
    TEST_ASSERT_TRUE(SHA512_BYTE_HASHSIZE == digest_len);
    TEST_ASSERT_TRUE(
...
TEST(scl_soft_test_sha_512, msg_2_blocks_digest_not_aligned)
{
    ...
    result = scl_sha(SCL_HASH_SHA512, message, sizeof(message) - 1, &digest[1],
                     &digest_len);
    TEST_ASSERT_TRUE(0 == result);
    TEST_ASSERT_TRUE(SHA512_BYTE_HASHSIZE == digest_len);
    TEST_ASSERT_TRUE(
