...
TEST_GROUP(scl_test_sha_256);

TEST_SETUP(scl_test_sha_256) { (void)scl_init(&scl); }

TEST_TEAR_DOWN(scl_test_sha_256) {}

TEST(scl_test_sha_256, msg_abc)
{
    int32_t result = 0;
    sha_ctx_t ctx;
...
TEST(scl_test_sha_256, msg_2_blocks)
{
    int32_t result = 0;
    sha_ctx_t ctx;
