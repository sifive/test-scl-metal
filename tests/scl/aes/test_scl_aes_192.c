...
TEST(scl_aes_192, ecb_F_1_34_high)
{
    ...
    /* F.1.3 ECB-AES192.Encrypt */
    result = scl_aes_ecb(&scl, tmp, plaintext_be, sizeof(plaintext_be), key192, sizeof(key192), SCL_ENCRYPT);
    TEST_ASSERT_TRUE(SCL_OK == result);
    TEST_ASSERT_TRUE(0 == memcmp(ciphertext_be, tmp, sizeof(ciphertext_be)));

    memset(tmp,0,sizeof(tmp));
    /* F.1.4 ECB-AES192.Decrypt */
    result = scl_aes_ecb(&scl, tmp, ciphertext_be, sizeof(ciphertext_be), key192, sizeof(key192), SCL_DECRYPT);
    TEST_ASSERT_TRUE(SCL_OK == result);
    TEST_ASSERT_TRUE(0 == memcmp(plaintext_be, tmp, sizeof(plaintext_be)));
}
...
TEST(scl_aes_192, cbc_F_2_34)
{
    ...
    result = scl_aes_cbc_init(&scl, key192, sizeof(key192), IV, sizeof(IV), SCL_ENCRYPT);
    TEST_ASSERT_TRUE(SCL_OK == result);
    ...
    /* F.2.4 CBC-AES192.Decrypt */
    memset(tmp,0,sizeof(tmp));
    result = scl_aes_cbc_init(&scl, key192, sizeof(key192), IV, sizeof(IV), SCL_DECRYPT);
    TEST_ASSERT_TRUE(SCL_OK == result);
...
TEST(scl_aes_192, cbc_F_2_34_high)
{
    ...
    /* F.2.3 CBC-AES192.Encrypt */
    result = scl_aes_cbc(&scl, tmp, plaintext_be, sizeof(plaintext_be), key192, sizeof(key192), IV, sizeof(IV), SCL_ENCRYPT);
    TEST_ASSERT_TRUE(SCL_OK == result);
    TEST_ASSERT_TRUE(0 == memcmp(ciphertext_be, tmp, sizeof(ciphertext_be)));

    /* F.2.4 CBC-AES192.Decrypt */
    memset(tmp,0,sizeof(tmp));
    result = scl_aes_cbc(&scl, tmp, ciphertext_be, sizeof(ciphertext_be), key192, sizeof(key192), IV, sizeof(IV), SCL_DECRYPT);
    TEST_ASSERT_TRUE(SCL_OK == result);
    TEST_ASSERT_TRUE(0 == memcmp(plaintext_be, tmp, sizeof(plaintext_be)));
}
