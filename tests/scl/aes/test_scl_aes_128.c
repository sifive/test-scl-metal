...
TEST(scl_aes_128, ecb_F_1_12)
{
    ...
    /* F.1.1 ECB-AES128.Encrypt */
    result = scl_aes_ecb_core(&scl, tmp, plaintext_be, sizeof(plaintext_be), SCL_ENCRYPT);
    TEST_ASSERT_TRUE(SCL_OK == result);
    ...
    /* F.1.2 ECB-AES128.Decrypt */
    result = scl_aes_ecb_core(&scl, tmp, ciphertext_be, sizeof(ciphertext_be), SCL_DECRYPT);
    TEST_ASSERT_TRUE(SCL_OK == result);
...
TEST(scl_aes_128, ecb_F_1_12_high)
{
    ...
    /* F.1.1 ECB-AES128.Encrypt */
    result = scl_aes_ecb(&scl, tmp, plaintext_be, sizeof(plaintext_be), key128, sizeof(key128), SCL_ENCRYPT);
    TEST_ASSERT_TRUE(SCL_OK == result);
    TEST_ASSERT_TRUE(0 == memcmp(ciphertext_be, tmp, sizeof(ciphertext_be)));

    memset(tmp,0,sizeof(tmp));
    /* F.1.2 ECB-AES128.Decrypt */
    result = scl_aes_ecb(&scl, tmp, ciphertext_be, sizeof(ciphertext_be), key128, sizeof(key128), SCL_DECRYPT);
    TEST_ASSERT_TRUE(SCL_OK == result);
    TEST_ASSERT_TRUE(0 == memcmp(plaintext_be, tmp, sizeof(plaintext_be)));
}
...
TEST(scl_aes_128, cbc_F_2_12)
{
    ...
    result = scl_aes_cbc_init(&scl, key128, sizeof(key128), IV, sizeof(IV), SCL_ENCRYPT);
    TEST_ASSERT_TRUE(SCL_OK == result);

    /* F.2.1 CBC-AES128.Encrypt */
    result = scl_aes_cbc_core(&scl, tmp, plaintext_be, sizeof(plaintext_be), SCL_ENCRYPT);
    TEST_ASSERT_TRUE(SCL_OK == result);
    TEST_ASSERT_TRUE(0 == memcmp(ciphertext_be, tmp, sizeof(ciphertext_be)));

    /* F.2.2 CBC-AES128.Decrypt */
    memset(tmp,0,sizeof(tmp));
    result = scl_aes_cbc_init(&scl, key128, sizeof(key128), IV, sizeof(IV), SCL_DECRYPT);
    TEST_ASSERT_TRUE(SCL_OK == result);

    result = scl_aes_cbc_core(&scl, tmp, ciphertext_be, sizeof(ciphertext_be), SCL_DECRYPT);
    TEST_ASSERT_TRUE(SCL_OK == result);
    TEST_ASSERT_TRUE(0 == memcmp(plaintext_be, tmp, sizeof(plaintext_be)));
}
...
TEST(scl_aes_128, cbc_F_2_12_high)
{
    ...
    /* F.2.1 CBC-AES128.Encrypt */
    result = scl_aes_cbc(&scl, tmp, plaintext_be, sizeof(plaintext_be), key128, sizeof(key128), IV, sizeof(IV), SCL_ENCRYPT);
    TEST_ASSERT_TRUE(SCL_OK == result);
    TEST_ASSERT_TRUE(0 == memcmp(ciphertext_be, tmp, sizeof(ciphertext_be)));

    /* F.2.2 CBC-AES128.Decrypt */
    memset(tmp,0,sizeof(tmp));
    result = scl_aes_cbc(&scl, tmp, ciphertext_be, sizeof(ciphertext_be), key128, sizeof(key128), IV, sizeof(IV), SCL_DECRYPT);
    TEST_ASSERT_TRUE(SCL_OK == result);
    TEST_ASSERT_TRUE(0 == memcmp(plaintext_be, tmp, sizeof(plaintext_be)));
}
